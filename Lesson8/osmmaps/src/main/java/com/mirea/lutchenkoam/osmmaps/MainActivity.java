package com.mirea.lutchenkoam.osmmaps;
...
import com.mirea.lutchenkoam.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker_1.setPosition(new GeoPoint(55.669938, 37.480225));
        marker_1.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"МИРЭА. Я там учусь)",
        ...
        marker_1.setTitle("РТУ МИРЭА");

        Marker marker_2 = new Marker(mapview);
        marker_2.setPosition(new GeoPoint(55.777763, 37.793819));
        marker_2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Измайловский парк. Много зелений и клещей",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker_2.setTitle("Измайловский парк");
    }
